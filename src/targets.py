...
\t bash src/push-image.sh stagex/{stage}-{name}:{version} out/{stage}-{name}
\t bash src/push-image.sh stagex/{stage}-{name}:sx$(RELEASE) out/{stage}-{name}
\t bash src/push-image.sh stagex/{stage}-{name}:latest out/{stage}-{name}
\t bash src/push-image.sh quay.io/stagex/{stage}-{name}:{version} out/{stage}-{name}
\t bash src/push-image.sh quay.io/stagex/{stage}-{name}:sx$(RELEASE) out/{stage}-{name}
\t bash src/push-image.sh quay.io/stagex/{stage}-{name}:latest out/{stage}-{name}
